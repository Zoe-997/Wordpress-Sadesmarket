(function ($) {
    ...
    $.fn.sadesmarket_countdown = function () {
        $(this).not('.loaded').on('sadesmarket_countdown', function () {
            $(this).each(function () {
                var el             = $(this),
                    data           = el.data('params'),
                    text_format    = '',
    ...
    window.addEventListener("load", function load() {
        ...
        if ($('.sadesmarket-countdown').length) {
            $('.sadesmarket-countdown').sadesmarket_countdown();
        }
