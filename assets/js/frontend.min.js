(function ($) {
            ...
            $.ajax({
                ...
                success  : function (response) {
                    ...
                    if (response) {
                        ...
                        if ($tabID.find('.add-to-cart>a,.yith-wcqv-button,.compare-button a.compare,.entry-summary a.compare,.yith-wcwl-add-to-wishlist a').length) {
                            $tabID.find('.add-to-cart>a,.yith-wcqv-button,.compare-button a.compare,.entry-summary a.compare,.yith-wcwl-add-to-wishlist a').sadesmarket_bootstrap_tooltip();
                        }
                    } else {
    ...
    $(document).on('click', '.shop-widget-area .widget .widget-title .arrow', function (e) {
    ...
    $(document).on('ovic_success_load_more_post', function (event, content) {
        if ($(event.target).find('.yith-wcqv-button,.compare-button a.compare,.entry-summary a.compare,.yith-wcwl-add-to-wishlist a').length) {
            $(event.target).find('.yith-wcqv-button,.compare-button a.compare,.entry-summary a.compare,.yith-wcwl-add-to-wishlist a').sadesmarket_bootstrap_tooltip();
        }
    ...
    window.addEventListener("load", function load() {
        ...
        if ($('.shop-control select').length) {
            $('.shop-control select').chosen({disable_search_threshold: 10});
        }
