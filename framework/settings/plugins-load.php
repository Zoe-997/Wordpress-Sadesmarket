...
if ( ! function_exists( 'sadesmarket_plugin_load' ) ) {
	function sadesmarket_plugin_load()
	{
		/*
		 ...
		 */
		$config = array(
			'id'           => 'sadesmarket_plugins',
			'default_path' => '',
			'menu'         => 'sadesmarket-install-plugins',
...
add_action( 'tgmpa_register', 'sadesmarket_plugin_load' );
