...
<div class="ovic-panel-rating">
    ...
    <p class="review-count"><?php echo sprintf( esc_html( _n( '%1$s Review', '%1$s Reviews', $rating_count, 'sadesmarket' ) ), sprintf( "%02d", $rating_count ) ); ?></p>
    <ul class="detail">
        <?php foreach ( $stars as $key => $rating ): ?>
            ...
            ?>
            <li>
                <span class="star"><?php echo esc_html( $key ) . esc_html__( ' Star', 'sadesmarket' ); ?></span>
                <span class="process">
