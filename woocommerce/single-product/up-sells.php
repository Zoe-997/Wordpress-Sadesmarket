...
$data    = sadesmarket_generate_carousel_products( 'woo_upsell' );
$section = array(
    'up-sells upsells products ovic-products hover-item-shadow',
    $data['style'],
    $data['class_added']
);
...
if ( $upsells && !empty( $data ) ) : ?>
    ...
    <section class="<?php echo esc_attr( implode( ' ', $section ) ); ?>">
        ...
        <?php
        $heading = !empty( $data['title'] ) ? $data['title'] : esc_html__( 'Up Sells Products', 'sadesmarket' );
