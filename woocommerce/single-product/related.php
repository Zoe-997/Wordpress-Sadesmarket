...
$data    = sadesmarket_generate_carousel_products( 'woo_related' );
$section = array(
    'related products ovic-products hover-item-shadow',
    $data['style'],
    $data['class_added']
);
...
if ( $related_products && !empty( $data ) ) : ?>
    ...
    <section class="<?php echo esc_attr( implode( ' ', $section ) ); ?>">
        ...
        <?php
        $heading = !empty( $data['title'] ) ? $data['title'] : esc_html__( 'Related Products', 'sadesmarket' );
