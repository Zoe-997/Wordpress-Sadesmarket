...
if (!class_exists('Ovic_Import_Database_Content')) {
    class Ovic_Import_Database_Content
    {
        ...
        {
            return 'https?(%3A|:)[%2F\\/]+(rc|demo|wp)\.alothemes\.com';
        }
        ...
        public function required_plugins($plugins)
        {
            return array(
                ...
                array(
                    ...
                    'source' => 'repo',
                    'source_type' => 'repo',
                    'file_path' => 'frequently-bought-together-for-woocommmerce/frequently-bought-together-for-woocommmerce.php',
                ),
                array(
        ...
        public function sample_data_packages($packages)
        {
            return array(
                'main' => array(
                    ...
                    'demo' => 'https://wp.alothemes.com/sadesmarket',
                    ...
                    if (!empty($items)) {
                        foreach ($items as $item) {
                            ...
                            if (!empty($_menu_item_url)) {
                                $_menu_item_url = str_replace('https://wp.alothemes.com/sadesmarket', $home_url, $_menu_item_url);
                                $_menu_item_url = str_replace('http://wp.alothemes.com/sadesmarket', $home_url, $_menu_item_url);
