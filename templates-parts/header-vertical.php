...
if ( $layout == 'popup' ) {
    ...
    $classes = 'box-nav-vertical sadesmarket-dropdown';
}
...
$vertical_title = sadesmarket_theme_option_meta(
    '_custom_metabox_theme_options',
    'vertical_title',
...
$show_more      = sadesmarket_theme_option_meta(
    '_custom_metabox_theme_options',
    'vertical_show_more',
    'metabox_vertical_show_more'
);
$show_less      = sadesmarket_theme_option_meta(
    '_custom_metabox_theme_options',
    'vertical_show_less',
    'metabox_vertical_show_less'
);
$always_open    = sadesmarket_get_option( 'vertical_always_open' );
...
if ( !empty( $vertical_menu ) ) : ?>
    <div class="header-vertical">
        <div class="<?php echo esc_attr( $classes ); ?>">
            ...
            <?php else: ?>
                <a href="#" data-sadesmarket="sadesmarket-dropdown" class="block-title">
            ...
            <div class="block-content sub-menu">
                ...
                wp_nav_menu(
                    array(
                        ...
                        'megamenu'        => true,
                        'mobile_enable'   => true,
                        'menu_class'      => 'sadesmarket-nav vertical-menu',
