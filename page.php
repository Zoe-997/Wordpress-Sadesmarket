...
$meta_class       = sadesmarket_theme_option_meta('_custom_page_side_options', null, 'page_extra_class');
        ...
        <div class="max-content-1110">
                    ...
                    while (have_posts()) :
                        ...
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            <div class="entry-content">
                                ...
                                the_content();
                                wp_link_pages(array(
                                        'before'      => '<div class="post-pagination"><span class="title">'.esc_html__('Pages:', 'sadesmarket').'</span>',
                                        'after'       => '</div>',
                                        'link_before' => '<span>',
                                        'link_after'  => '</span>',
                                    )
            ...
            <?php if ($page_layout['layout'] != 'full') : ?>
                <aside id="secondary" class="widget-area <?php echo esc_attr($page_layout['sidebar']); ?>"
                       role="complementary"
                       aria-label="<?php esc_attr_e('Page Sidebar', 'sadesmarket'); ?>">
