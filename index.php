...
$post_style   = sadesmarket_get_option( 'blog_list_style', 'standard' );
$page_title   = sadesmarket_get_option( 'blog_page_title', 1 );
$sub_class    = 'blog-page';
if ( is_single() ) {
        ...
        <div class="max-content-1110">
            ...
            <?php if ( $page_layout['layout'] != 'full' ) : ?>
                <aside id="secondary" class="widget-area <?php echo esc_attr( $page_layout['sidebar'] ); ?>"
                       role="complementary"
                       aria-label="<?php esc_attr_e( 'Post Sidebar', 'sadesmarket' ); ?>">
