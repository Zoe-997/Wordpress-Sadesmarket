...
class Elementor_Ovic_Brand extends Ovic_Widget_Elementor
{
    ...
    {
        return esc_html__( 'Brand', 'sadesmarket' );
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'category',
            [
                'label'       => esc_html__( 'Products Brand', 'sadesmarket' ),
        ...
        $this->add_control(
            'background',
            [
                'label'     => esc_html__( 'Background', 'sadesmarket' ),
        ...
        $this->add_responsive_control(
            'space',
            [
                'label'      => esc_html__( 'Padding', 'sadesmarket' ),
        ...
        $this->add_group_control(
            ...
            [
                'name'     => 'border',
                'label'    => esc_html__( 'Border', 'sadesmarket' ),
        ...
        $this->add_control(
            'full_width',
            [
                'label'     => esc_html__( 'Item Full Width', 'sadesmarket' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label'   => esc_html__( 'Ovic Hover Animation', 'sadesmarket' ),
