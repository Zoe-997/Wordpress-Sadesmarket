...
class Elementor_Ovic_Iconbox extends Ovic_Widget_Elementor
{
    ...
    {
        return esc_html__('Iconbox', 'sadesmarket');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => sadesmarket_preview_options('ovic_iconbox'),
                'default' => 'style-01',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label'       => esc_html__('Descriptions', 'sadesmarket'),
                'description' => esc_html__('using tag <span></span> for special text', 'sadesmarket'),
            ]
        );
