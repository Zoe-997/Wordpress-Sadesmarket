    ...
    public function content( $atts, $content = null )
    {
        ...
        <div class="<?php echo esc_attr( $css_class ); ?>">
            <?php if ( !empty( $atts['date'] ) ):
                $params = array(
                    'days_text' => !empty( $atts['days_text'] ) ? $atts['days_text'] : esc_html__( 'd', 'sadesmarket' ),
                    'hrs_text'  => !empty( $atts['hrs_text'] ) ? $atts['hrs_text'] : esc_html__( 'h', 'sadesmarket' ),
                    'mins_text' => !empty( $atts['mins_text'] ) ? $atts['mins_text'] : esc_html__( 'm', 'sadesmarket' ),
                    'secs_text' => !empty( $atts['secs_text'] ) ? $atts['secs_text'] : esc_html__( 's', 'sadesmarket' ),
                );
