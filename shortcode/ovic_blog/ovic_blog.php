...
class Shortcode_Ovic_Blog extends Ovic_Addon_Shortcode
{
    ...
    public function content( $atts, $content = null )
    {
        ...
        $query           = new WP_Query( sadesmarket_shortcode_posts_query( $atts ) );
        if ( $atts['image_full_size'] == 'yes' ) {
            add_filter( 'sadesmarket_post_thumbnail_width', function () {
                return false;
            } );
            add_filter( 'sadesmarket_post_thumbnail_height', function () {
                return false;
            } );
        }
        ob_start();
        ...
        <?php
        if ( $atts['image_full_size'] == 'yes' ) {
            remove_all_filters( 'sadesmarket_post_thumbnail_width' );
            remove_all_filters( 'sadesmarket_post_thumbnail_height' );
        }
